...
namespace AStar
{
    public class PathFinder : IPathFinder
    {
        ...
        private readonly IPriorityQueue<TilePosition> _open;
        ...
        public PathFinder(byte[,] grid, PathFinderOptions pathFinderOptions = null)
        {
            ...
            _open = new PriorityQueue<TilePosition>(new ComparePfNodeMatrix(_mCalcGrid));
            ...
            lock (this)
            {
                ...
                while (_open.Count > 0)
                {
                    ...
                    for (var i = 0; i < _direction.GetLength(0); i++)
                    {
                        ...
                        _open.Push(new TilePosition(newLocationX, newLocationY));
        ...
        private List<PathFinderNode> OrderClosedListAsPath(TilePosition end)
        {
            _closed.Clear();
